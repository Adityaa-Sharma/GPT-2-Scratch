...
def train_tokenizer(dataset, vocab_size=32000, train_tokens=10_000_000):
...
def prepare_openwebtext(vocab_size=32000, token_limit=1_000_000_000, chunk_size=10000):
